...
def get_apriltag_corners(world_x, world_y, world_z, tag_size):
    tag_size = tag_size / 2
    return np.array([[world_x,world_y-tag_size,world_z-tag_size],  # First point
                     [world_x,world_y+tag_size,world_z-tag_size],  # Second point
                     [world_x,world_y+tag_size,world_z+tag_size],  # Third point
                     [world_x,world_y-tag_size,world_z+tag_size]], # Fourth point
                     dtype = np.float32)
...
if __name__ == "__main__":
    ...
    # Apriltag parameter 
    APRILTAG_SIZE = 0.134
    APRILTAG_LOCATION_PATH = "/home/charlie/HCC/State Estimation Lab-20240516/Lab1/apriltag_id_3_4.csv"
    ...
    # Camera parameters
    FX = 1469.6040476019102
    FY = 1462.373902695629
    CX = 1053.4954104566043
    CY = 432.11650923905216

    DIST_COEFF = np.array([6.61871188e-01, -8.22235368e+00, 7.64330006e-03, 5.36283031e-02, 7.45576884e+01])
    ...
    # Get Benchmark
    bench_mark_path = "/home/charlie/HCC/State Estimation Lab-20240516/Lab1/benchmark.csv"
    ...
    Output_csv_file = "camera_pose.csv"  
